    ...
    if dialect_name == 'postgresql':
        try:
            ...
            search_info = {
                ...
                'method': 'fulltext' if len(results) > 0 or not query or not query.strip() else 'ilike_fallback'
            }
    ...
    if query and query.strip():
        ...
        try:
            ...
            search_info = {
                ...
                'filters': filters,
                'count': len(results),
                'method': 'ilike_fallback' if len(results) > 0 and len(material_ids) == 0 else ('hybrid' if use_vector_search else 'fulltext_only'),
                'text_weight': text_weight,
